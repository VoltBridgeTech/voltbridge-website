...
const trustMetrics = [
  { stat: '£150,000', detail: 'in negotiated energy & gas savings for UK business portfolios' },
...
const services = [
  {
    ...
    description: 'Tendering and negotiating multi site energy & gas contracts with leading UK suppliers.',
  },
  {
    icon: <ShieldCheck className="w-6 h-6 text-[#0D76FA]" />,
    title: 'Energy & gas risk management',
  ...
  },
  {
    ...
    description: 'Consumption dashboards, ESG reporting and advisory to accelerate your net zero energy & gas roadmap.',
  },
];
    ...
    <div className="relative flex flex-col gap-24 pb-24 pt-16 sm:pt-20 text-white">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 lg:px-8">
        <div className="flex items-center justify-center gap-5 text-center">
          ...
          <p className="text-base md:text-lg font-semibold text-white/90">VoltBridge Ltd is proudly registered with the Energy Ombudsman, ensuring trust, transparency, and customer protection across energy & gas services</p>
        </div>
      </section>
      ...
      <section className="relative mx-auto flex w-full max-w-6xl flex-col gap-12">
        ...
        >
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white">Energy & gas solutions engineered for CFOs and operations leaders</h2>
            <p className="text-white/70 lg:max-w-2xl">
              We orchestrate procurement, risk cover and reporting so your finance team keeps energy & gas spend under control without diverting internal resources.
            </p>
          </div>
          <a
            href="/services"
      ...
      >
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <motion.div variants={fadeUp} transition={{ duration: 0.6, ease: 'easeOut' }} className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white">How we safeguard long term energy & gas savings</h2>
            <p className="text-white/70 lg:max-w-2xl">
              Our analysts and energy & gas traders act as an extension of your team—from the initial audit through monthly energy & gas consumption reviews and renewals.
            </p>
          </motion.div>
          <motion.a
            variants={fadeUp}
      ...
      <section id="case-studies" className="relative mx-auto w-full max-w-6xl rounded-[36px] border border-white/12 bg-[#07070D]/88 px-8 py-14 shadow-[0_40px_130px_-80px_rgba(0,0,0,0.85)] backdrop-blur-xl">
        ...
        >
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white">Real world energy & gas results for real businesses</h2>
            <p className="text-white/70 lg:max-w-2xl">
              These outcomes are representative of the projects we manage: complex energy & gas contracts, multi site portfolios and ambitious savings targets.
            </p>
          </div>
        </motion.div>
      ...
      <section className="relative mx-auto grid w-full max-w-6xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-white">Let’s talk about your corporate energy & gas spend</h2>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-4 text-left">
            ...
            <p className="text-white/70">
              Access live business energy & gas tariffs, compare suppliers in minutes and complete your switch with guided support from our team.
            </p>
            <a
              href="https://voltbridge.tickd.co.uk"
              target="_blank"
