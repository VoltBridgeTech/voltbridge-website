    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="space-y-6 text-white">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">1. Definitions</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">2. Company Information</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">3. Scope of Services</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">4. Use of the Site</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">5. Client Obligations</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">6. Limitation of Liability</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">7. Indemnity</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">8. Intellectual Property Rights</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">9. Data Protection and Privacy</h2>
            <p className="mb-4">
              ...
              9.2 Please refer to our <Link to="/privacy-policy" className="text-vb-electric-1 hover:underline">Privacy Policy</Link> for details on how we collect, store, and use your information.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">10. Regulatory Compliance</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">11. Termination and Suspension</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">12. Changes to Terms</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">13. Severability</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">14. Entire Agreement</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">15. Governing Law and Jurisdiction</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-vb-electric-1">16. Contact Information</h2>
            <p className="mb-4">
